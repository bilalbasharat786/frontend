...
const Blog = () => {
  ...
  return (
    <section id="blog" className="py-16 md:py-24 bg-white font-sans overflow-hidden">
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="flex items-center text-[12px] md:text-[13px] text-gray-400 mb-5 space-x-2 font-medium tracking-wide">
                  <span className="hover:text-gray-600 transition-colors">{post.author}</span>
                  <span className="text-gray-200">•</span>
                  <span>{post.date}</span>
                  <span className="text-gray-200">•</span>
                  <span className="text-orange-500 uppercase">{post.category}</span>
                </div>
