...
const Features = () => {
  ...
  return (
    <section id="features-section" className="py-16 md:py-24 bg-white font-sans overflow-hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 md:gap-16 text-center mb-24 md:mb-32">
          {features.map((item, index) => (
            ...
            >
              ...
              <h3 className="text-xl md:text-2xl font-medium text-gray-900 mb-4 tracking-tight">{item.title}</h3>
              <p className="text-gray-400 leading-relaxed text-sm md:text-base font-light">{item.desc}</p>
            </motion.div>
          ))}
        </div>
