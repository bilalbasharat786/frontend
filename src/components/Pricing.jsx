      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 items-center gap-8 lg:gap-0">
          {plans.map((plan, index) => (
            ...
            >
              <h3 className="text-2xl font-semibold text-gray-800 mb-8 uppercase tracking-widest">
                {plan.name}
              </h3>
              ...
              <div className="flex justify-center items-baseline mb-10">
                ...
                <span className="text-orange-500 text-5xl md:text-7xl font-bold mx-1">
                  {plan.price}
                </span>
              ...
              <ul className="space-y-5 mb-12 text-left inline-block w-full">
                {plan.features.map((feature, i) => (
                  <li
                    key={i}
                    className={`flex items-center gap-4 text-[14px] md:text-[15px] ${feature.active ? "text-gray-600" : "text-gray-300"}`}
                  >
                    <span
                      className={`flex-shrink-0 w-5 h-5 flex items-center justify-center rounded-full text-[10px] ${feature.active ? "bg-green-100 text-green-600" : "bg-gray-100 text-gray-400"}`}
                    >
                      {feature.active ? "✓" : "✕"}
                    </span>
                    <span
                      className={
                        !feature.active ? "line-through opacity-50" : ""
                      }
                    >
                      {feature.text}
                    </span>
