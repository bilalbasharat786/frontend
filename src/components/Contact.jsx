...
const Contact = () => {
  ...
  return (
    <section id="contact-section" className="py-16 md:py-24 bg-gray-50 font-sans overflow-hidden">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col items-center text-center group">
            <div className="w-12 h-12 md:w-16 md:h-16 flex items-center justify-center  rounded-full shadow-sm mb-6 ">
              <img src={iconAddress} alt="Address" className="w-6 h-6 md:w-8 md:h-8 object-contain" />
            </div>
          ...
          <motion.div variants={itemVariants} className="flex flex-col items-center text-center group">
            <div className="w-12 h-12 md:w-16 md:h-16 flex items-center justify-center rounded-full shadow-sm mb-6 ">
              <img src={iconPhone} alt="Phone" className="w-6 h-6 md:w-8 md:h-8 object-contain" />
            </div>
          ...
          {/* Email */}
          <motion.div variants={itemVariants} className="flex flex-col items-center text-center group sm:col-span-2 md:col-span-1">
            <div className="w-12 h-12 md:w-16 md:h-16 flex items-center justify-center  rounded-full shadow-sm mb-6 ">
              <img src={iconEmail} alt="Email" className="w-6 h-6 md:w-8 md:h-8 object-contain" />
            </div>
            <p className="text-orange-500 font-medium text-lg">
          ...
          <form className="space-y-6 md:space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              <div className="flex flex-col items-start w-full">
                <label className="text-gray-700 mb-3 font-semibold text-sm uppercase tracking-wide">First Name</label>
                <input type="text" className="w-full h-10 border border-stone-300 bg-white p-4 rounded-full focus:outline-none focus:border-orange-500 focus:bg-white transition-all " />
              </div>
              <div className="flex flex-col items-start w-full">
                <label className="text-gray-700 mb-3 font-semibold text-sm uppercase tracking-wide">Last Name</label>
                <input type="text" className="w-full h-10 border border-stone-300 bg-white p-4 rounded-full focus:outline-none focus:border-orange-500 focus:bg-white transition-all " />
              </div>
            </div>
            ...
            {/* Email Field */}
            <div className="flex flex-col items-start w-full">
              <label className="text-gray-700 mb-3 font-semibold text-sm uppercase tracking-wide">Email</label>
              <input type="email" className="w-full h-10 border border-stone-300 bg-white p-4 rounded-full focus:outline-none focus:border-orange-500 focus:bg-white transition-all " />
            </div>

            {/* Subject Field */}
            <div className="flex flex-col items-start w-full">
              <label className="text-gray-700 mb-3 font-semibold text-sm uppercase tracking-wide">Subject</label>
              <input type="text" className="w-full h-10 border border-stone-300 bg-white p-4 rounded-full focus:outline-none focus:border-orange-500 focus:bg-white transition-all " />
            </div>

            {/* Message Field */}
            <div className="flex flex-col items-start w-full">
              <label className="text-gray-700 mb-3 font-semibold text-sm uppercase tracking-wide">Message</label>
              <textarea 
                rows="5" 
