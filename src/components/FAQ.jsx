        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            {faqData.map((item, index) => (
              <motion.div key={index} variants={itemVariants} className="flex flex-col text-left">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-6 items-start group">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800 mb-3 text-left group-hover:text-orange-500 transition-colors">Bank Loan</h3>
                  <p className="text-gray-400 leading-relaxed font-light mb-4 text-left text-sm md:text-base">
                    Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.
                  </p>
                  <a href="#" className="text-orange-500 font-bold hover:underline text-xs tracking-widest uppercase block text-left">
                    Learn More →
                  </a>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6 items-start group">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800 mb-3 text-left group-hover:text-orange-500 transition-colors">Banking Consultation</h3>
                  <p className="text-gray-400 leading-relaxed font-light mb-4 text-left text-sm md:text-base">
